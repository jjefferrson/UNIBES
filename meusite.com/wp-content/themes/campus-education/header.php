        ...
        <?php if ( get_theme_mod('campus_education_button_text','') != "" ) {?>
          <div class="col-lg-2 col-md-4"> 
            <div class="donate-link">            
              <a href="<?php echo esc_html( get_theme_mod('campus_education_button_link','') ); ?>"><?php echo esc_html( get_theme_mod('campus_education_button_text','') ); ?></a>    
            </div>          
          </div>
        <?php }?>
      </div>
    ...
    <div class="container">
      <div class="menu-sec">
        ...
        <div class="row">
          ...
          <div class="menubox col-lg-7 col-md-7 p-0">
            <div class="nav">
